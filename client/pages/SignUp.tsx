    ...
    <section className="container py-12">
      <div className="mx-auto max-w-2xl">
        ...
        <p className="text-muted-foreground mt-2">
          Choose your role and sign up to start donating or managing requests.
        </p>
        <Tabs
          className="mt-8"
          value={tab}
        ...
        >
          ...
          <TabsContent value="donor" className="mt-6">
            <Card id="donor-signup">
              <CardHeader>
                <CardTitle>Donor Sign Up</CardTitle>
              </CardHeader>
              <CardContent>
                <AuthForm role="donor" mode="signup" />
              </CardContent>
              <CardFooter>
          ...
          <TabsContent value="hospital" className="mt-6">
            <Card id="hospital-signup">
              <CardHeader>
                <CardTitle>Hospital Sign Up</CardTitle>
              </CardHeader>
              <CardContent>
                <AuthForm role="hospital" mode="signup" />
              </CardContent>
              <CardFooter>
                <p className="text-sm text-muted-foreground w-full text-center">
                  Already have an account?{" "}
